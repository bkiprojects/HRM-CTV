...
namespace BKI_HRM
{
    public partial class f206_dm_ctv_de: Form
    {
        ...
        {
            this.Load += new EventHandler(f206_dm_ctv_de_Load);
        ...
        private void f206_dm_ctv_de_Load(object sendrer, EventArgs e)
        {
            try
            {
